...
final class Config {
  ...
  public static $meta       = array('author'      => 'Danny Allen',
                                    'description' => 'A weekly overview of the development activity in KDE.',
                                    'keywords'    => 'kde, commit-digest, danny allen, dannya, plasma, akonadi, decibel, oxygen, solid, phonon, strigi');
